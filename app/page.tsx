export default function Home() {
  return (
    <div className="flex flex-1 items-center justify-center bg-hilda-bg px-6">
      <div className="w-full max-w-md rounded-hilda border border-hilda-border/15 bg-hilda-surface p-6 shadow-sm">
        ...
        <div className="mt-6">
          <a className="inline-flex rounded-hilda-sm bg-hilda-heading px-4 py-2.5 text-sm font-medium text-hilda-inverse" href="/app">
            Open app
          </a>
        </div>
      </div>
